...
def letters_only(text):
    ...
    print("[TRACE] letters_only input:", text)
    ...
    print("[TRACE] letters_only output:", result)
...
def palindrome_helper(text):
    ...
    print("[TRACE] helper input:", text)

    if len(text) == 1:
        print("[TRACE] helper output:", True)
        return True

    else:
        answer = text[0] == text[-1] and palindrome_helper(text[1:-1])
        print("[TRACE] helper output:", answer)
        return answer

def is_palindrome(text):
    """Returns true if the input is a palindrome, else false"""
    print("[TRACE] main input:", text)
    text = letters_only(text)
    answer = palindrome_helper(text)
    print("[TRACE] main output:", answer)
    return answer
